...
const commonMethodList = {
    ...
    top: {type: 'normal'},
    bottom: {type: 'normal'},
    translateY: {type: 'transform'},
    translateX: {type: 'transform'},
    translateZ: {type: 'transform'},
    translate3d: {type: 'transform'},
    translate: {type: 'transform'},
    skewY: {type: 'transform'},
    skewX: {type: 'transform'},
    skew: {type: 'transform'},
    matrix: {type: 'transform'},
    matrix3d: {type: 'transform'},
    rotate: {type: 'transform'},
    rotateX: {type: 'transform'},
    rotateY: {type: 'transform'},
    rotateZ: {type: 'transform'},
    rotate3d: {type: 'transform'},
    scale: {type: 'transform'},
    scaleX: {type: 'transform'},
    scaleY: {type: 'transform'},
    scaleZ: {type: 'transform'},
    scale3d: {type: 'transform'}
};
...
const allSameStyle = (el, stepStyles) => {
    ...
    .every(styleRule => el.style[styleRule.property] === styleRule.value);
};
...
export const animationEffect = (el, animateCommands) => new Promise((resolve, reject) => {
    ...
    const animateStep = () => {
        ...
        el.style.webkitTransformOrigin = stepStyles.webkitTransformOrigin;
